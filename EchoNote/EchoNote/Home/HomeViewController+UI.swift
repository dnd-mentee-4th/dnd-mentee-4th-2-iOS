...
extension HomeViewController {
    ...
    func setupPercentLabel() {
        setupEmptyFlowerLabel(title: "분리수거", accentColor: UIColor(red: 2.0 / 255.0, green: 188.0 / 255.0, blue: 121.0 / 255.0, alpha: 1.0))
    ...
    func setupEmptyFlowerLabel(title: String, accentColor: UIColor) {
    ...
    func setupPercentageLabel(title: String, percent: String, accentColor: UIColor) {
